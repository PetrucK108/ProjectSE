    ...
    <div class="absolute w-full max-w-sm p-8 bg-gray-800 rounded-xl shadow-lg">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <select name="jurusan" required
                class="w-full mb-4 px-4 py-2 rounded bg-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-cyan-400">
                ...
                <!-- Tambahkan pilihan jurusan lain sesuai kebutuhan -->
            </select>
